...
def evaluate(**deps):
    ...
    # edit
    horizon_for_transform = Config.horizon//2 + 1
    model_low_config = utils.Config(
        Config.model,
        savepath='model_low_config.pkl',
        horizon=horizon_for_transform,
    ...
    model_high_config = utils.Config(
        Config.model,
        savepath='model_high_config.pkl',
        horizon=horizon_for_transform,
        transition_dim=transition_dim,
        cond_dim=observation_dim,
        dim_mults=Config.dim_mults,
